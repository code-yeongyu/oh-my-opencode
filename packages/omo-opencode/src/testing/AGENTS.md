...
- `getMisplacedCategoryConfigDiagnostics()` — scans discovered OpenCode config sources after config loading and emits warning toasts for ignored top-level `categories`.
